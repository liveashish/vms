...
<!-- // Themer END -->
  ...
  <!-- Bootstrap -->
  <script src="../../admin/common/bootstrap/js/bootstrap.min.js"></script>
...
<?php
 ...
 if(isset($_POST['submit'])){
      ...
      if(!empty($username) && !empty($password)){
        $query="SELECT * FROM vendor_details where vendorcode='$username' AND vendorpass=SHA('$password')";
        $result=mysql_query($query);
        
        if(mysql_num_rows($result)==1){
  session_start();
  $_SESSION['last_login']=$last_login;
  $_SESSION['login_vendor']=$username;
  $sql=mysql_query("UPDATE vendor_details SET lastlogin=NOW() where vendorcode='$username'");
  header("location:../dashboard");
                echo '<div id="notify">
