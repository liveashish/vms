                ...
                <div class="innerLR">
                 ...
                 <div class="widget-body">
                      ...
                      <div class="row-fluid">
                            ...
                            echo '<h3 style="margin-bottom:20px;font-size:20px;margin-top:20px;">Welcome '.$name.'</h3>';
                            $inc="incomplete";
                            $compl="complete";
                            $rev="reviewed";
                        ...
                        <tbody>';
                            while($row_order=mysql_fetch_array($run_sql)){
                              ...
                              echo    '
                                  ...
                                  <td><i class="icon-ok-sign" style="color: rgb(12, 163, 37);font-size: 30px;/* text-align: center; */"></i></td>
                            ...
                            if(isset($_GET['instock'])){
                                $vendor_stock=$_GET['instock'];
                              
                              $review_query=mysql_query("UPDATE `order` SET `vendor_stock`='".$vendor_stock."', `status`='".$rev."' WHERE `order_id`='".$order_id."'") or die("Error in query");
                              echo "heue";
                            }
